...
game.party.push(pokemon[150], pokemon[123], pokemon[131]);
...
game.party.forEach((pokiName) => {
  console.log(pokiName.name);
});
...
pokemon.forEach((startPoke) => {
  if (startPoke.starter === true) console.log(startPoke.name);
});
